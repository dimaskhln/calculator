...
export const messages = {
  ru: {
    ...
    ABOUT_mainInfoBody:
      'Меня зовут Дмитрий. Мне 26 лет. Я web-разработчик. Мне нравится создавать удобные интуитивные интерфейсы и наполнять приложения логикой. Я люблю программировать и видеть результат своей работы.',
    ...
    ABOUT_footerGithubTitle: 'Посмотреть репозиторий этого проекта',
  ...
  en: {
    ...
    ABOUT_mainInfoBody:
      "My name is Dmitriy. I'm 26. I'm a web-developer. I like to create user-friendly interfaces and fill applications with logic. I love programming process and can't wait to see result of my work!",
    ...
    ABOUT_goalsBody: '',
    ABOUT_footerGithubTitle: 'See repo of this project',
